...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { //pegando os dados do formulário
    ...
    $url = 'http://localhost/dashboard/api-designOdyssey/usuarios/index.php'; // URL do endpoint da API
    ...
    if ($result) {
        echo "<p>usuarios adicionado com sucesso!</p>"; //MENSAGEM CASO SEJA SUCESSO OU ERRO
        header("location:index.php");
    } else {
        echo "<p>Erro ao adicionar usuarios.</p>";
    }
}
?>
<style>
